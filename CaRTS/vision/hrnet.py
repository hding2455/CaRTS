...
class HRNet(VisionBase):
    ...
    def __init__(self, params, device):
        ...
        super(HRNet, self).__init__(params, device)
        ...
        self.stage1_cfg = model_param['STAGE1']
        ...
        self.stage2_cfg = model_param['STAGE2']
        ...
        self.stage3_cfg = model_param['STAGE3']
        ...
        self.stage4_cfg = model_param['STAGE4']
